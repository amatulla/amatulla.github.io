		...
		<div class="row">
  			<div class="column">
				...
				<a href="https://www.facebook.com/amatullamlokhandwala">
  					<img src="img/facebooklogo.png" alt="facebook link" style="width:35px;height:35px;border:0;">
				</a>
			</div>
  			<div class="column">
			
				<a href="https://github.com/amatulla">
  					<img src="img/githublogo.png" alt="github link" style="width:40px;height:40px;border:0;">
				</a>
			</div>
  			<div class="column">
			
				<a href="mailto:amatulla.lokhandwala@mail.utoronto.ca">
  					<img src="img/mail.png" alt="mail link" style="width:35px;height:35px;border:0;">
				</a>
  			...
  			<div class="column">
				...
				<a href="https://linkedin.com/in/amatulla-lokhandwala/">
  					<img src="img/linkedin.png" alt="linkedin link" style="width:35px;height:35px;border:0;">
				</a>
			</div>
			<div class="column">

				<a href="https://www.instagram.com/amatulla_lokhandwala/">
  					<img src="img/insta_logo.png" alt="insta link" style="width:38px;height:38px;border:0;">
				</a>
			</div>
		</div></center>
